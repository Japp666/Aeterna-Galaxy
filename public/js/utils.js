...
const gameState = {
    ...
    resources: { metal: 500, crystal: 500, helium: 200, energy: 200, research: 0 },
    ...
    buildingsList: [
        ...
        { key: 'defense_turret', name: 'Turn de Apărare', baseCost: { metal: 120, crystal: 50, helium: 30 }, baseBuildTime: 20, production: {}, hp: 100, image: 'https://i.postimg.cc/ydLx2C1L/coming-soon.png' },
...
function updateResources() {
    Object.keys(gameState.production).forEach(resource => {
        gameState.resources[resource] = Math.min(
            gameState.resources[resource] + gameState.production[resource] / 3600,
