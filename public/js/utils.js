...
export function generateEmblemFromParams(params) {
  return `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50">
    <circle cx="25" cy="25" r="20" fill="${params.color}"/>
    <text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="#fff" font-size="12">${params.name[0]}</text>
  </svg>`;
}
